#!/usr/bin/env python3
"""
ntfy Task Helpers - Context Managers, Decorators, and Event Functions
=====================================================================

Provides Python utilities for automatic notification on task lifecycle events:
- TaskContext: context manager for auto-notify on task completion
- @notify_on_complete: decorator for function completion notifications
- on_task_start/on_task_end: explicit lifecycle hooks
- on_error, on_long_task: event-driven notifications
