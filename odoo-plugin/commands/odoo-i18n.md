...
```bash
# Extract
python "${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_extractor.py" --module <path> --lang <code>

# Validate
python "${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_validator.py" --po-file <path> [--lang <code>] [--strict]

# Missing
python "${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_reporter.py" --module <path> --lang <code> [--format text|json|csv] [--min-pct <N>]
