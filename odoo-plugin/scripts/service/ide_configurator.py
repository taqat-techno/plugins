...
def generate_pycharm_local_config(
    ...
    content = f"""\
<!-- Generated by odoo-service-plugin v3.0.0 | Target: PyCharm 2023.3+ -->
...
def generate_vscode_tasks(
    ...
    tasks = {
        "_generated": "odoo-service-plugin v3.0.0 | Target: VSCode 1.85+ tasks format 2.0.0",
        "version": "2.0.0",
        "tasks": [
            {
            ...
            },
            {
                "label": "DB: Backup",
                "type": "shell",
                "command": "python scripts/service/db_manager.py backup --db ${input:database} --output backups/",
                "presentation": {"reveal": "always"},
                "problemMatcher": []
            }
        ],
...
def generate_vscode_launch(
    ...
    launch_config = {
        "_generated": "odoo-service-plugin v3.0.0 | Target: VSCode 1.85+ launch format 0.2.0",
        "version": "0.2.0",
        "configurations": [
            {
...
def generate_vscode_settings(output_dir: str = ".") -> Path:
    ...
    settings = {
        "_generated": "odoo-service-plugin v3.0.0 | Target: VSCode 1.85+ with Pylance",
...
def generate_vscode_extensions(output_dir: str = ".") -> Path:
    ...
    extensions = {
        "_generated": "odoo-service-plugin v3.0.0 | Target: VSCode 1.85+",
        "recommendations": [
            "ms-python.python",
