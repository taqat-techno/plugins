# SCSS Variable Reference — Complete Guide

## Version Scope

The SCSS variable systems (`$o-theme-font-configs`, `$o-color-palettes`, `$o-website-values-palettes`) are **version-independent** -- they work identically across Odoo 14-19. The variable names, structure, and key names do not change between versions.

**What DOES change by version**: Bootstrap utility classes (4.x vs 5.x) and asset bundle syntax (legacy vs modern). See `data/version_mapping.json` for version-specific details.
