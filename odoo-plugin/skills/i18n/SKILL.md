...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_extractor.py --module <path> --lang <code> [--output <dir>] [--no-pot] [--verbose]
```
...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_validator.py --po-file <path> [--lang <code>] [--strict] [--output <file>]
```
...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_converter.py --action convert --po ar.po --output ar_fixed.po
```
...
- name: Validate Arabic translations
  run: python scripts/i18n/i18n_validator.py --po-file my_module/i18n/ar.po --lang ar --strict
```
...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_reporter.py --module <path> --lang <code> [--format text|json|csv] [--output <file>] [--min-pct <N>]
```
...
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_extractor.py --module /path/ --lang ar --no-pot
# 2. Merge (preserves existing translations)
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_converter.py \
    --action merge --base /path/i18n/ar.po --new /path/i18n/ar.po --output /path/i18n/ar_merged.po
# 3. Check remaining gaps
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_reporter.py --module /path/ --lang ar
```
...
```bash
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_converter.py --action merge --base ar.po --new ar_new.po --output ar_merged.po
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_converter.py --action clean --po ar.po
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_converter.py --action stats --po ar.po
python ${CLAUDE_PLUGIN_ROOT}/scripts/i18n/i18n_converter.py --action convert --po ar.po --output ar_fixed.po
```
