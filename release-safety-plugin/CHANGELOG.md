...
- `fires-on-workflow-dispatch-missing-run-button` targets `github-actions-release-safety`
- `ignores-github-actions-cache-speedup` asserts no skill of this plugin fires (`min: 0`, `max: 0`, `arm: both`)
