...
- `fires-on-narration-audio-cuts-between-scenes` targets `remotion`
- `ignores-ffmpeg-merge-mp4-files` asserts no skill of this plugin fires (`min: 0`, `max: 0`, `arm: both`)
