...
```
/sprint                              # Quick sprint summary
/sprint --full                       # Comprehensive hybrid CLI+MCP report
/sprint --full "Project Alpha"       # Full report for specific project
/sprint --full --sections "progress,bugs,tests"  # Specific sections
```
...
## Full Sprint Report (--full)

Generate a comprehensive sprint report using **both CLI and MCP** for optimal data gathering. This mode demonstrates hybrid approach - using CLI for fast bulk queries and MCP for rich details.
...
1. Fix critical bug #456 before sprint end
...
*Report generated by Claude Code with Azure DevOps Plugin*
...
```
/sprint --full --type "Bug"
```

#### Include Specific Sections Only

```
/sprint --full --sections "progress,bugs,tests"
```

#### Export to File

```
/sprint --full --output sprint15-report.md
```
...
- `/workday --tasks` - Personal task list
- Say "any failing builds?" for build health check (skill-handled)

> Previously: /full-sprint-report
