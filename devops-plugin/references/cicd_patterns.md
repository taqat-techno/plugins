...
- `odoo-service-plugin/references/deployment_patterns.md` -- SSH deployment scripts
- `odoo-test-plugin/references/testing_patterns.md` -- CI test runner patterns
- `odoo-test-plugin/references/playwright_e2e_patterns.md` -- Full Playwright E2E reference
