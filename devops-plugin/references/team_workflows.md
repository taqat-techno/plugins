...
> **Purpose**: This reference provides organization-specific workflows, conventions, and best practices for Azure DevOps usage. These patterns reflect how the team operates and should be followed for consistency.
