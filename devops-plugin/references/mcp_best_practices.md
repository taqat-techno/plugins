...
> **Purpose**: This reference provides Claude with best practices for using Azure DevOps MCP tools effectively. Use these patterns for optimal user experience and reliable results.
