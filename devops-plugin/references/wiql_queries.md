...
> **Purpose**: This reference provides common Work Item Query Language (WIQL) patterns for Azure DevOps. Use these queries with CLI (`az boards query --wiql`) for powerful work item filtering.
