...
> **Purpose**: This reference provides Claude with best practices for using Azure DevOps CLI effectively. Use these patterns for optimal performance, security, and reliability.
