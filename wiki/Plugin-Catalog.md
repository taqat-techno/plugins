...
| 4 | **ui-ux-mechanics** | `3.1.0` | design | 1 command, 2 agents, 3 skills, hooks | [[Ui Ux Mechanics Plugin\|Ui-Ux-Mechanics-Plugin]] | [`ui-ux-mechanics-plugin/README.md`](../../ui-ux-mechanics-plugin/README.md) |
...
- **ui-ux-mechanics**: 1 — `/ui-ux-mechanics` (dispatcher to skills)
...
- **rag**: `rag-log-scanner`
- **ui-ux-mechanics**: `design-reviewer`, `wireframe-builder`
...
The `ui-ux-mechanics` plugin's Figma integration uses an external Figma MCP that the user configures separately — it is not shipped inside the plugin. The `figma-mcp-mechanics` skill adds the safe-write layer (write-access probing, metadata-lossiness handling, auto-layout/variant mechanics, prototype-link-safe edits) on top of whatever the external Figma MCP exposes.
...
- **ui-ux-mechanics**, **pandoc**, **remotion**, **ntfy** — lighter hook sets, mostly advisory
...
| `ui-ux-mechanics` | `pandoc` | Export design docs/specs from Markdown to PDF/Word with the same toolchain |
