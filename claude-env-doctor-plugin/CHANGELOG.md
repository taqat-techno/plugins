...
- `fires-on-scheduled-task-shows-console-window` targets `windows-script-and-task-authoring`
- `ignores-macos-bash-config-append` asserts no skill of this plugin fires (`min: 0`, `max: 0`, `arm: both`)
